...
- obscuring errors returned by the API. This typically happens when you indiscriminately catch all HTTP errors (e.g., by using `httr::http_error()`) and return a generic error message while each HTTP code has a precise meaning about what went wrong.
