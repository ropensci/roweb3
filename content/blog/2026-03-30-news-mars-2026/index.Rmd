...
It is now available in English, [Spanish](https://devguide.ropensci.org/es/index.es.html) and [Portuguese](https://devguide.ropensci.org/pt/index.pt.html).
Read more in the [release announcement](/blog/2026/03/02/devguide-1.0.0/)
...
The [official mailing lists of the R project](https://www.r-project.org/mail.html) like [R-package-devel](https://blog.r-hub.io/2019/04/11/r-package-devel/) are full of important and useful information.
How to browse them, given that the default website is not easy to search?
You can use the [mail-archive](https://mail-archive.com/r-devel@r-project.org/) website (thanks to Hugo Gruson for the reminder!) or a new project by James Balamuta: the [R Mailing Lists Archive](https://r-mailing-lists.thecoatlessprofessor.com/)!

### "Claude Code: Setting up ast-grep with R support"

Thanks to Mauro Lepore for sharing this blog post by Emil Hvitfeldt:
["Claude Code: Setting up ast-grep with R support"](https://emilhvitfeldt.com/post/ast-grep-r-claude-code/).
ast-grep is a tool for querying code by syntax rather than brittle regular expressions.
The blog post describes how to add R support to this tool, and how to take advantage of it when using Claude.
...
- With the {cli} R package you can change the default handler for messages. See the [docs](https://cli.r-lib.org/articles/semantic-cli.html#cli-messages).
It seems mostly used to muffle messages, e.g. in [flir](https://github.com/etiennebacher/flir/blob/9254cd01d258d0bafcee41a44e5caa7104fed832/R/lint.R#L104).
