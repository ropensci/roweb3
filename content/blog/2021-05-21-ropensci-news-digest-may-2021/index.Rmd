...
categories: []
tags: []
description: social co-working, R-universe, rOpenSci at useR! 2021
output:
  html_document:
    keep_md: yes
params:
...
We have no less than categories of events coming up: social co-working events, a community call, a conference with contributions from four rOpenSci staff members. :sparkles:
...
[Registration](https://user2021.r-project.org/participation/registration/) for the useR! 2021 has begun, with  Early Bird Deadline until May 28th. 
