...
This blog post describes challenges ahead and initial changes we are making.
...
One tool is requesting authors outline the areas that have been AI generated, and specifying the scope of their own work.
...
Software reviews at rOpenSci often require early-stage software seeking feedback, so this is not a match for rOpenSci. 
...
Such openness may require authors to highlight aspects of their software which they would encourage or desire reviewers to focus on.
...
Reviewers who know that all tests were automatically generated may opt to review them in terms of high-level architecture, or may choose to pay special attention to tests.
Either way, knowing that tests were generated by AI tools would be useful and important.

The descriptions may refer to relevant documentation in the repository, such as:
...
This is our first pass at providing guidelines and guardrails for AI to ensure rOpenSci software review continues to improve while retaining its essential value and values.

With more package submissions having some component of AI contribution, the editorial board thought it essential to provide these updates to manage the process as we learn more about what works and what doesn't.
