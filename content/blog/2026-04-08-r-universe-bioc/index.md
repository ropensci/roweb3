...
Information about each package is available on `https://bioc.r-universe.dev/{pkgname}`. For example,  [https://bioc.r-universe.dev/DESeq2](https://bioc.r-universe.dev/DESeq2) provides details on the DESeq2 package as shown below:
