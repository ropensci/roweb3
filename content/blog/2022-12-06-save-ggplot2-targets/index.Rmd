...
That's where someone in the community (it was [Miles McBain](/author/miles-mcbain/) on rOpenSci Slack space :tada:) suggested using [tarchetypes](https://docs.ropensci.org/tarchetypes) [hooks](https://docs.ropensci.org/tarchetypes/reference/index.html#hooks).
