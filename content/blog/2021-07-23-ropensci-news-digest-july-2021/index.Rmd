...
The rOpenSci development guide does not have any specific guidance for that (whereas e.g. the tidyverse ADD PLEDGE).
If you follow the Tidyverse example, then it'd make sense to _test_ your package in those R versions on continuous integration.
...
The README also has a list of the reimplementations, which is fun to look at for R history sake!
