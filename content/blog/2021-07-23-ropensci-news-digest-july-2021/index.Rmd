...
In an R package DESCRIPTION you can use the [roles](https://www.loc.gov/marc/relators/relacode.html) found in `utils:::MARC_relator_db_codes_used_with_R`: `r toString(utils:::MARC_relator_db_codes_used_with_R)`.
