...
format_post <- function(dir) {
  ...
  if (post$description != "") {
    string <- paste0(string, ". ", sub("[\\.\\!\\?]$", "", post$description), ".")
      ...
      string <- paste(string, "This post was discussed on the [R Weekly Highlights podcast](https://podcastindex.org/podcast/1062040?episode=42926387120) hosted by Eric Nantz and Mike Thomas..")
    }
  } else {
    string <- paste0(string, ".")  
  }
...
### Calls for contributions
Thanks to [an idea](https://github.com/ropensci-review-tools/pkgcheck/issues/142) from Egor Kotov, the pkgcheck package now contains a stand-alone function to use during package development, to quickly check whether your function names are unique:
