...
You can imitate this behavior: if you have a Pandoc version that works well for your use case, just install that one on your production GitHub Actions workflow for instance.[^5]

[^5]: That's the strategy one can use with Hugo when building a static website with Hugo!
