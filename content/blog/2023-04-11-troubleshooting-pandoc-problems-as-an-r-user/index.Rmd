...
[^2]: R package pandoc is quite recent <https://github.com/cderv/pandoc>, dedicated to use Pandoc CLI from R.
    You can also use the more usual `rmarkdown::pandoc_convert()` to access pandoc used with R Markdown.
...
They can also be passed at command line, for instance rmarkdown's output format function can use this with `rmarkdown::pandoc_variable_arg()`.
...
-   With R Markdown, `rmarkdown::find_pandoc()` will allow you to know where is the Pandoc binary located.
    You can run it in terminal, or use `rmarkdown::pandoc_*` family of function
