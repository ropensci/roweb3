...
Unfortunately, it is when we start troubleshooting a tool that all the *magic* unveiled :wink:.
...
They can also be passed at command line, for instance rmarkdown's output format function caan use this with `rmarkdown::pandoc_variable_arg()`.
