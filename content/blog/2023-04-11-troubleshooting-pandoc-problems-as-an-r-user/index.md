...
- extension. [Extensions](https://pandoc.org/MANUAL.html#extensions) are modifiers of the behavior of Pandoc readers and writers. For instance, the ["smart" extension](https://pandoc.org/MANUAL.html#extension-smart) that interprets some typography, for instance two dashes as en-dash[^dash], 

Format, extension, option, variables (https://pandoc.org/MANUAL.html#variables) …
Difference between extensions and options. Extensions are extensions of a format not extensions of Pandoc. Not all options/extensions work for a format.
Use pandoc::pandoc_list_extensions() to list extensions for a format.
