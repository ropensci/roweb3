...
# DH: Need to comment this to get the output on the index.md file.
...
```{r cff-keys, echo=FALSE, message=FALSE}
library(dplyr)

knitr::kable(matrix(cff_schema_keys(sorted = TRUE), ncol = 3),
  col.names = NULL
)
```
