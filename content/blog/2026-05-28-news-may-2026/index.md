...
{{< figure src="https://ropensci.r-universe.dev/targets/card.png" alt="">}}

- the universe such as its number of packages and contributors, etc.

{{< figure src="https://ropensci.r-universe.dev/card.png" alt="">}}
...
- Seven at ['4/review(s)-in-awaiting-changes'](https://github.com/ropensci/software-review/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%224/review(s)-in-awaiting-changes%22):
...
[Git release notes](https://%20github.blog/open-source/git/highlights-from-git-2-54/#h-rewrite-history-with-git-history); [Git docs](https://%20git-scm.com/docs/git-history).
...
It means it's becoming possible to add comments to `DESCRIPTION` files, for instance to note why a given dependency was added.

### {cross} R package for running code with different package versions

Have you ever used [Git worktree](https://masalmon.eu/2024/01/23/git-worktree/) to load several R package versions at once (in different sessions), for instance to create a benchmark? Davis Vaughan made such endeavors much smoother with his [cross R package](https://github.com/DavisVaughan/cross):

- cross does use Git worktree under the hood, installs different package versions in temporary libraries and runs R code with the different versions...
- but it has a user-friendly interface!
...
James Balamuta wrote two thoughtful posts on a [tricky situation and how it was resolved](https://blog.thecoatlessprofessor.com/posts/closing-the-footnote-loop/). Tldr; James' work on portable R was used in another repo and only acknowledged with a footnote in a comment. Thankfully, all concerned people had a helpful conversation.
