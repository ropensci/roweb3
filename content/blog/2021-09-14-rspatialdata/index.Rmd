...
The rnaturalearth package (by [Andy South](https://github.com/andysouth)) facilitates communication with [Natural earth](http://www.naturalearthdata.com/) map data. It allows us to easily download and visualise boundaries of countries and boundaries of states within countries as well.
...
{{< figure src = "hospitals-lagos-nigeria.jpg" width = "600" alt = "A black and white map of Logos, Nigeria, showing main arteries in yellow and with blue shapes outlining hospital locations" class = "center" link = "https://rspatialdata.github.io/osm.html">}}
