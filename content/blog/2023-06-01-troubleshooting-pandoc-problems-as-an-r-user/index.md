...
Now that you understand the relation with Pandoc, the next step is to understand how Pandoc works.
...
Not all extensions work for a format, make sure you read the docs (😉), use [`pandoc::pandoc_list_extensions()`](https://cderv.github.io/pandoc/reference/pandoc_list_extensions.html) to list extensions available for a format.
...
This is another level of advanced details that will be skip in this post... but now you know about default files[^5].
...
As an R user, do not forget that Pandoc supports a lot of your publication tools; and that there's a handy R package to interact with Pandoc: pandoc.
