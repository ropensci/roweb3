  ...
  list(
    ...
    tar_target(
      simple_plot,
      {
        ...
        ggsave("simple_plot.png", simple_plot)
      },
      format = "file"
    ),
    tar_target(
      complex_plot,
      {
        ...
        ggsave("complex_plot.png", complex_plot)
      },
      format = "file"
    )
  )
...
From my simple problem of finding the "best" way of saving ggplot2 objects in targets workflows, I've learned quite a ton about both targets and ggplot2 internals. I hope you liked the journey as much as I
