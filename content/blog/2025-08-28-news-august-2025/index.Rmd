...
Our community manager Yanina Bellini Saibene was interviewed [again](/blog/2025/04/28/news-april-2025/#ropensci-in-the-news) in *Nature*, for the article ["Six questions to ask before jumping into a spreadsheet"](www.nature.com/articles/d41586-025-01241-6)
...
The recordings of the talks for useR! 2025 virtual component have been posted on [YouTube](https://www.youtube.com/watch?v=OIM3VmFRGDI&list=PL77T87Q0eoJgDiU_yXZ6c6Fp8PZTsDvg4).
...
For those of you interested in [controlling package verbosity](/blog/2024/02/06/verbosity-control-packages/),
Klaus Vigo helpfully [reported](https://discuss.ropensci.org/t/ropensci-please-shut-up-verbosity-control-in-packages/3790/17)
that " R4.6 will ship with a [bit more verbosity control](https://cran.r-project.org/doc/manuals/r-devel/NEWS.html)"
...
Thanks to Gábor Csárdi and Christophe Dervieux for chiming in.
The workaround is to add `local::.` under `setup-r-dependencies` to the field,
as stated by James Balamuta in the [relevant GitHub issue](https://github.com/quarto-dev/quarto-r/issues/217#issuecomment-2470666968).
