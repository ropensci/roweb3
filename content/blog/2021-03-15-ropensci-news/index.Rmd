...
text <- sprintf("There are %s recently closed and active submissions", nrow(issues))
if (no_holding > 0) {
  text <- paste0(
    text,
    sprintf(
...
`r length(usecases)` use cases of our packages and resources have been reported since the 1st of January.
