...
draw_sound(file)
```
{{<figure src="spec_example-1.png" alt="Example of an oscilogram and a spectrogram" caption="Example of an oscilogram and a spectrogram generated by the draw_sound() function" width="600">}}
...
```
{{<figure src="spec_zoom_example-1.png" alt="Usage of the zoom argument" caption="Usage of the zoom argument" width="600">}}
...
```
{{<figure src="spec_annotation_example-1.png" alt="Usage of the annotation argument" caption="Usage of the annotation argument" width="600">}}
