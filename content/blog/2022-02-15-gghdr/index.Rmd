...
__After:__
```{r gghdr-boxplot, echo=TRUE, message=FALSE, warning=FALSE, hugoopts = list(alt = "A similar plot as the left one showing highest density regions with gghdr package so that any other geom can easily be added like in the ggplot2 framework.")}
library(gghdr)
library(ggplot2)
