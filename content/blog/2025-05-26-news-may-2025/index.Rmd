...
We are seeking co-maintainers for the {pkgcheck} package that powers that. 
...
If you're interested and already part of our slack group, please join our dedicated `#pkgcheck` channel, otherwise email `mark@ropensci.org`.
...
- Tuesday July 1st, 2025 4:00 PM UTC, ["Research Software Engineering and R"](/events/coworking-2025-07/) with [Yanina Bellini Saibene](/author/yanina-bellini-saibene/) and cohost [Saranjeet Kaur Bhogal](/author/saranjeet-kaur-bhogal/).
...
They help acknowledge more precisely an organization (a company that owns the copyright, a non-profit that funded the work, etc.) in package's metadata.
