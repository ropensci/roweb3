...
flir, an R package that not only detects some of lintr's checks faster, but also repairs them automatically, and like lintr lets you set your own preferences;
