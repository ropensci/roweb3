...
twitterImg: blog/2022/07/11/post-template/name-of-image.png
...
In this example we are going to download price data for the SP500 index from 1950 to today (2022-07-13), analyze its financial performance and also visualize its prices in a graph.
...
The output of `yfR` is a tibble (dataframe) with the stock price data. We can use it to calculate the annual financial performance of the index:
...
In 1950-01-03, the index was valued at 16.66. Today (2022-07-13), after roughly 72 year, the value of the index is 3818.800049. The total return for the SP500, without accounting for inflation, is equivalent to 22 822%, which is very impressive! Overall, anyone holding stocks for that long  has done very well financially.

We can also calculate its performance as coupounded annual return:
...
Over the 72 of existance for the SP500 index, it returned a annual coumpounded interest of 7.78%. 
...
In this second example, we will investigate the financial performance of a set of stocks. First, lets download the current composition of the SP500 index and select 10 random stocks.
...
paste0("The tickers are: ", paste0(rnd_tickers, collapse = ", "))
```

```
[1] "The tickers are: AAPL, DHI, AMZN, CMS, FCX, NRG, EXR, CFG, CI, AWK"
```
...
Out of the 10 stocks, one had the number of missing days higher than the default threshold (75%). This leaves us with just nine stocks.
...
As we can see, some stocks, such as AMZN and AAPL, did much better than others. We can check this numerically by calculating their compounded return over the period:
...
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">2,131.95%</td>
<td class="gt_row gt_right">28.16%</td></tr>
    <tr><td class="gt_row gt_left">AMZN</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">1,531.37%</td>
<td class="gt_row gt_right">24.99%</td></tr>
    <tr><td class="gt_row gt_left">AWK</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">774.53%</td>
<td class="gt_row gt_right">18.91%</td></tr>
    <tr><td class="gt_row gt_left">CI</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">693.57%</td>
<td class="gt_row gt_right">18.00%</td></tr>
    <tr><td class="gt_row gt_left">CMS</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">532.53%</td>
<td class="gt_row gt_right">15.88%</td></tr>
    <tr><td class="gt_row gt_left">DHI</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">665.50%</td>
<td class="gt_row gt_right">17.66%</td></tr>
    <tr><td class="gt_row gt_left">EXR</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">2,008.72%</td>
<td class="gt_row gt_right">27.58%</td></tr>
    <tr><td class="gt_row gt_left">FCX</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">&minus;16.89%</td>
<td class="gt_row gt_right">&minus;1.47%</td></tr>
    <tr><td class="gt_row gt_left">NRG</td>
<td class="gt_row gt_right">12.51781</td>
<td class="gt_row gt_right">91.65%</td>
<td class="gt_row gt_right">5.33%</td></tr>
  </tbody>
...
Package `yfR` was reviewed by [Alexander Fischer](https://github.com/s3alfisc) and [Nic Crane](https://github.com/thisisnic) and I'm grateful for their feedback. The package has improved significantly after the review process of [ropensci](https://ropensci.org/). I'm also grateful to [Joshua Ulrich](https://www.quantmod.com/), the maintainer of [quantmod](https://www.quantmod.com/), which wrote `quantmod::getSymbols`, the main function used gy `yfR::yf_get`
