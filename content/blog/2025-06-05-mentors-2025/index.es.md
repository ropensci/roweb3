...
Nuestros nuevos mentores provienen de una amplia variedad de disciplinas y son voces activas dentro de la comunidad R en la región, participando en distintos grupos e iniciativas. Con su apoyo, nuestro nuevo grupo de Campeon(e|a)s no solo van a desarrollar sus proyectos, sino también a crecer como líderes en ciencia abierta y desarrollo de software de investigación.
...
Soy docente e investigadora de la Unidad de Métodos y Acceso a Datos (UMAD) de la Facultad de Ciencias Sociales (Udelar, Uruguay). Me dedico a la investigación social aplicada y su intersección con la ciencia de datos, específicamente, las áreas de políticas públicas y análisis masivo de texto. También imparto hace más de diez años cursos básicos y avanzados de R. 

Me interesa participar en el programa como mentora y seguir proyectos de diferente tipo, incluso en otros campos de investigación a los que estoy habituada.  
...
He trabajado en la evaluación de programas de prevención en varios países de América Latina. Actualmente, estoy desarrollando talleres para enseñar el uso de software que mejora la reproducibilidad y el rigor de la investigación. Estos talleres se centran en el uso de R y técnicas de análisis estadístico, como el aprendizaje automático y las variables latentes.

Estoy profundamente comprometido con el fortalecimiento de las capacidades técnicas dentro de las comunidades; creo en equipar a las personas con las herramientas necesarias para ejecutar sus proyectos de la mejor manera posible. Fui mentor en una cohorte anterior del programa y quiero seguir participando de esta iniciativa.
...
Estoy muy contento de poder participar como mentor en esta edición del programa. Decidí postularme porque las comunidades de práctica han desempeñado un rol clave en mi crecimiento personal y profesional, y veo en este espacio una gran oportunidad para retribuir parte de lo mucho que recibí a lo largo de mi carrera. Creo firmemente en la importancia de seguir creando y sosteniendo comunidades que promuevan la inclusión de nuevas personas en el mundo de la programación.

Del programa espero aprender del amplio conocimiento y la experiencia de mis colegas, además de contribuir con mi perspectiva y trayectoria. Me entusiasma especialmente la posibilidad de establecer conexiones con profesionales de distintas áreas para expandir nuestros horizontes y fortalecer el impacto positivo que R y su comunidad pueden tener en la resolución de problemas y desafíos actuales.
...
Anteriormente trabajé en industria desarrollando soluciones de datos para diferentes empresas en América Latina y Estados Unidos. Mi experiencia incluye el desarrollo de modelos, automatización de procesos, creación de APIs, y desarrollo e implementación de aplicaciones. 
