...
Do you need to write some code wrapping a web resource such as an API delivering data?
...
The gh package only offers low level functions, that are used in for instance the incredibly useful PR helpers in usethis.
