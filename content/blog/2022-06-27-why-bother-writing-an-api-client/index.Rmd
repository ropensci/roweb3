...
* **Getting data from several result pages** (example: gh (automatically implemented in the `gh::gh()` action but done under the hood by https://gh.r-lib.org/reference/gh_next.html));
