...
These days web APIs are everywhere (scientific data sources, your system for Customer relationship management, cat facts API...). 
...
Examples: [specieshindex](https://jessicatytam.github.io/specieshindex/), [spocc](https://docs.ropensci.org/spocc/).
...
It is also a way to see whether they are responsive.
...
In **theory**, adding a custom user-agent with contact details (link to your package development repository) might allows API maintainers to contact you if your package is causing issues or if it's interacting with (soon to be) deprecated endpoints.
