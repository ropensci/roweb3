...
We hold [Community Calls](https://ropensci.org/commcalls/) every 3 months to share knowledge that is relevant to our community and consistent with [our vision and mission](https://ropensci.org/about/). These are free and open for anyone to attend and provide opportunities for us to connect with rOpenSci community members around the world.
...
We will also be very grateful if you propose speakers, resources, or encourage others to weigh in by sharing the link to your favorite topic.

You can [read more details on our community calls repository](https://github.com/ropensci-org/community-calls). 

We look forward to hearing your ideas.  Let's build the calendar together.     
### Coworking
