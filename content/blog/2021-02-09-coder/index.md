...
twitterImg: blog/2021-02-09-coder/hex_lg.png
...
- `codebook()` takes this a step further. It not only list the relevant codes but also translate them into plain text.
...
An early version of the coder package was significantly improved after generous contributions made by [Emely C Zabore](https://github.com/zabore) and [David Robinson](/author/david-robinson/) during the [the peer-review process](https://github.com/ropensci/software-review/issues/381)  for rOpenSci. I therefore wish to express my deepest gratitude to both of them, as well as to the rOpenSci community at large!
