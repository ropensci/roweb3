...
```{r,  hugoopts=list(alt="Bar plot showing that most patients have 0 comorbidity.", caption="Distribution of the Charlson comorbidity index. Patients in this cohort are healthy. Most have zero comorbidities and only a few have several.")}
