...
- documentation
- community
description: Documentación multilingüe en un paquete R al alcance de tu mano.
...
Nos complace anunciar el nuevo [Grupo de Trabajo Multilingüe del R Consortium](https://github.com/RConsortium/multilingual-documentation-wg).
Este Grupo de Trabajo surgió tras los debates mantenidos durante el [R Project Sprint 2023](https://contributor.r-project.org/r-project-sprint-2023/) y supervisará la implementación del soporte de documentación multilingüe en R y organizará los esfuerzos de traducción de la comunidad.
...
Instala la versión experimental [rhelpi18n](https://github.com/eliocamp/rhelpi18n) y el módulo de traducción de ejemplo base.es:
...
Pero aún así, la gran mayoría de los paquetes están documentados en inglés y el [pequeño número de paquetes documentados en otros idimas](https://cderv.rbind.io/2018/03/11/non-english-pkg-in-cran/) se ajustan aparentemente a su público objetivo.
...
Ambas son soluciones alternativas que llevan al límite lo que el lenguaje de programación R puede hacer en términos de funcionalidad multilingüe.
Además, como estas soluciones no son nativas, pueden resultar difíciles de mantener y no son escalables.

Por eso presentamos el proyecto de paquete experimental **rhelpi18n** [^2].
Este paquete es un banco de pruebas para implementar un soporte sin fallas para la documentación multilingüe con el objetivo de integrarlo en el propio R una vez que madure.
...
[^2]: El nombre proviene del [neurónimo](https://en.wikipedia.org/wiki/Numeronym) de "internacionalización".
...
Además de presentar la documentación traducida, rhelpi18n también proporciona herramientas para que las personas que desarrollan creen nuevos módulos de traducción.
...
rhelpi18n::i18n_module_create(module_name = "glue.es", 
                              package_path = glue_dir,  # Camino a la copia local del codigo fuente de glue
                              language = "es", 
                              module_path = dir)
```
...
El proyecto está en sus primeras fases y las cosas avanzan rápido.
