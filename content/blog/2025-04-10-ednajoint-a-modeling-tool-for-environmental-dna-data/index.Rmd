...
<!--/html_preserve-->
{{< imgtxt src = "eDNAjoint_logo.png" alt = "eDNAjoint hex logo, blue gradient background with dark blue DNA helixes and a fishing hook catching the word eDNAjoint" width = "400">}}
<!--/html_preserve-->
