...
[sofa](https://docs.ropensci.org/sofa/), Provides an interface to the NoSQL database [CouchDB](http://couchdb.apache.org). [Issue for volunteering](https://github.com/ropensci/sofa/issues/82)
