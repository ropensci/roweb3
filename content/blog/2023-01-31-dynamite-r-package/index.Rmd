...
Following the terminology in our DMPM paper`r katex::katex_html("^{1}", displayMode = FALSE)`, this is a recurring intervention, in contrast to an atomic intervention where `r katex::katex_html("z_{81}=1", displayMode = FALSE)` and zero otherwise.
