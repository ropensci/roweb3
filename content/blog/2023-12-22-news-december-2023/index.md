...
### "A package a day" series on Mastodon!

We've started sharing about one package a day from our federated community of open source software developers, on [Mastodon](https://mastodon.social/@rOpenSci@hachyderm.io/111522245481433695)!
Follow us on Mastodon, or search for `from:@rOpenSci@hachyderm.io #apackageaday` to find all posts until now.
