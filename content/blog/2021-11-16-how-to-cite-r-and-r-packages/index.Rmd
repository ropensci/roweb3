...
This makes it hard to prioritorize work on open software projects. 
...
I know that every citation I get for my [weathercan](https://docs.ropensci.com/weathercan) package warms my heart `r emo::ji("heart_eyes_cat")` (and helps my CV)
...
I always advise citing statistical packages, no question, and any package that is specific to a scientific domain or methodology (i.e. if you used [magick](https://docs.ropensci.com/magick) to process images before analysis,
