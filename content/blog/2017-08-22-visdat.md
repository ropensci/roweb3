...
{{< gallery class="content-gallery" caption="On the left (if your screen is wide enough) are the old `visdat` and vismiss plots, and on the right are the new `visdat` and vismiss plots.">}}
{{< img src="/assets/blog-images/2017-08-22-visdat/blog-vis-dat-compare-1.png" width="50%" caption="old plot" >}} 
{{< img src="/assets/blog-images/2017-08-22-visdat/blog-vis-dat-compare-2.png" width="50%" caption="new plot" >}}
{{< img src="/assets/blog-images/2017-08-22-visdat/blog-vis-dat-compare-3.png" width="50%" caption="old plot" >}}
