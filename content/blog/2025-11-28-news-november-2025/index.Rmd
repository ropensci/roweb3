...
The slides and recording have been [posted](https://ropensci.org/events/csidnetwork-2025/)!

### rOpenSci at posit::conf(2025): recordings

Recordings from posit::conf(2025) are now publicly available on YouTube!
Many excellent talks to enjoy and learn from, including those from rOpensci community members.

* [Mauro Lepore](/author/mauro-lepore) and [Eric Scott](/author/eric-scott) both presented [lightning talks](https://reg.conf.posit.co/flow/posit/positconf25/attendee-portal/page/sessioncatalog/session/1745351143742001aTfb). Mauro talked about ["Approaching Positron from RStudio"](https://www.youtube.com/watch?v=X6PZ_RiZp44), Eric about ["Enabling geospatial workflow management with targets: an R package origin story"](https://www.youtube.com/watch?v=RmTtugX1CoE).
