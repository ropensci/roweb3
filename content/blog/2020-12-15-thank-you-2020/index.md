...
*   Contributors to our guides
    *   rOpenSci Statistical Software Peer Review[^4], [Maëlle Salmon](/author/maëlle-salmon), [Rich FitzJohn](/author/rich-fitzjohn/), [Yilong Zhang](https://github.com/elong0527), [Francisco Rodriguez-Sanchez](https://frodriguezsanchez.net/), [François Briatte](https://github.com/briatte), [Leonardo Collado-Torres](http://lcolladotor.github.io/);
    *   rOpenSci Packages: Development, Maintenance, and Peer Review[^5] [Carl Boettiger](/author/carl-boettiger/), [Hugo Gruson](/author/hugo-gruson/), [Luke McGuinness](/author/luke-mcguinness/), [Aaron Wolen](/author/aaron-wolen/), and peer review Editors
    *   rOpenSci Community Contributing Guide[^3], [Toby Hodges](https://github.com/tobyhodges), [Julia Stewart Lowndes](/author/julia-stewart-lowndes/)
    *  Plus wisdom from the whole community that isn't reflected in direct issues and pull requests to specific guides
*   Authors of our special covid-era post on Leveraging Open Data Resources for Remote Research[^6], [Sam Albers](/author/sam-albers/), [Brooke Anderson](/author/brooke-anderson/), [Robin Lovelace](/author/robin-lovelace/), [Ben Marwick](/author/ben-marwick/), [Anton Van de Putte](/author/anton-van-de-putte/), [Ilaria Prosdocimi](/author/ilaria-prosdocimi/), [Ben Raymond](/author/ben-raymond/), [Louise Slater](/author/louise-slater/), [Claudia Vitolo](/author/claudia-vitolo/), [Sam Zipper](/author/sam-zipper/);
*   Captioners for a Community Call who wrote up what they learned[^7], [Matthias Grenié](/author/matthias-grenié/), [Hugo Gruson](/author/hugo-gruson/);
