...
- find out which Git commited deleted a _line_? You can [do that](https://stackoverflow.com/questions/16181279/find-out-which-commit-removed-a-particular-word-line-in-git/16181840#16181840) with `git log -S<string> path/to/file` or 
