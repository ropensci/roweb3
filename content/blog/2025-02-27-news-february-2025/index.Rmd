...
Our pkgcheck package used both for our submission checks, and in [pkgcheck-action](https://github.com/ropensci-review-tools/pkgcheck-action) now has two additional checks:
