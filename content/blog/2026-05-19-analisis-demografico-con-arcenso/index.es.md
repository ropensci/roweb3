...
{{< figure src="portada-blog.png" alt="Ilustración del Censo en Argentina con el logo de ARcenso y rOpenSci, un hornero (ave nacional) y material gráfico de los censos de 1970 y 1980." caption="Portada blog ARcenso">}} 
...
{{< figure src="shiny_arcenso.es.png" width="600" alt="Aplicación Shiny ARcenso: Consulta de Datos Censales con filtros por año, alcance geográfico y temática, mostrando tabla de alfabetismo 1970."  caption="Explorador interactivo de datos censales con `arcenso_app()`" >}}
