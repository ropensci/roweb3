...
```{=html}
{{< figure src="shiny-arcenso.png" width="600" alt="Aplicación Shiny ARcenso: Consulta de Datos Censales con filtros por año, alcance geográfico y temática, mostrando tabla de alfabetismo 1970." caption="Explorador interactivo de datos censales con `arcenso_app()`" >}}
```
