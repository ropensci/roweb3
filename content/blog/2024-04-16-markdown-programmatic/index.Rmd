...
Furthermore there are different _flavors_ or _specifications (specs)_ of Markdown[^md-flavours], which add some [extended syntax], like emoji written with colons.
...
The [tinkr package](http://docs.ropensci.org/tinkr/) dreamed up by Maëlle Salmon and maintained by Zhian Kamvar parses Markdown to XML using Commonmark, allows you to extract and manipulate Markdown using XPath via the [xml2](https://xml2.r-lib.org/) package. 
