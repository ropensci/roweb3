---
title: Software Libre de Investigación en América Latina, conversaciones con la comunidad de Campeon(a|e)s de rOpenSci
author:
...
tags:
  ...
  - comunidad
description: "De cara al llamado 2026 del Programa de Campeon(a|e)s de rOpenSci, conversamos con integrantes de la cohorte en español sobre sus experiencias, aprendizajes y el valor de participar en una comunidad de software libre y ciencia abierta."
params: 
  doi: "10.59350/mef07-0zq93"
---

En el marco del [llamado abierto al Programa de Campeon(a|e)s de rOpenSci 2026](/es/blog/2026/01/12/programachamps2026/) —cuarta cohorte global y segunda cohorte en español— realizamos una nueva edición de [Conversaciones con la comunidad](/es/commcalls/). 
En esta oportunidad, Yanina Bellini Saibene moderó un [encuentro con Erik Navarro, Diana García y Luis Verde Arregoitia](/es/commcalls/champions-latino-2026/), quienes compartieron sus experiencias como campeon(a|e)s y mentor(a|e)s del programa, los aprendizajes obtenidos y las oportunidades que abre participar en una comunidad de software libre y ciencia abierta.
...
Sumado a los entrenamientos, Erick destacó la importancia de contar con una mentora (Pao Corrales) que lo guió durante el proceso de revisión y eso lo facilitó mucho. Le ayudo a dividir las tareas en partes manejables y [resolver inconvenientes técnicos](https://github.com/ropensci-review-tools/roreviewapi/issues/82). 
...
Ademas, rescató que el [proceso de revisión](https://devguide.ropensci.org/es/index.es.html) es muy util desde el minuto uno: su paquete mejoró significativamente solo con cumplir los estándares de revisión, incluso antes de recibir feedback de revisores y editores.
...
Diana participa del programa desarrollando un paquete nuevo para compartir datos de secuenciación de DNA y RNA de pacientes con cáncer de mama metastásico. 
Su motivación principal es hacer datos abiertos y fáciles de analizar para otros laboratorios, de esa manera espera permitir que otros investigadores hagan nuevas preguntas a los datos ya generados.
...
Podes ver el video completo y todos los recursos compartidos en el evento en la [página del webinario](/es/commcalls/champions-latino-2026/).