...
Your package might be used by people at ease in different languages than the one you wrote e.g. error messages for.
...
Key to this PR is the used of `delayedAssign()` in `data/penguins.R`.
