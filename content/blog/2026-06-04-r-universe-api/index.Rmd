...
In this post, we provide a short overview of use cases with the R-Universe API.
...
The ggsegverse website performs **client-side requests**: 
it queries the R-Universe API when you open the webpage, through a [JS script](https://github.com/ggsegverse/ggsegverse.github.io/blob/aea3723f885387ca9399408ccfbcc7a1ec9d7820/js/api.js).
