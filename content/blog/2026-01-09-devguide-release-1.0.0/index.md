...
Our guide is now trilingual (English, [Spanish](https://devguide.ropensci.org/es/index.es.html), [Portuguese](https://devdevguide.netlify.app/pt/index.pt))!
...
- New category for [rOpenSci internal and peer-review tools](https://devdevguide.netlify.app/softwarereview_policies#package-categories).

- New explicit rule to only [submit one package at a time](https://devdevguide.netlify.app/softwarereview_author#lifecycle).

- New requirement to not call the [default branch "master"](https://devdevguide.netlify.app/pkg_building#version-control).

## Editor Guide, Author Guide & Reviewer Guide

The guides that live in our guide. :smile_cat:

The whole [editor guide](https://devdevguide.netlify.app/softwarereview_editor) was revamped so that its structure follows the flow of submissions,
so that it better explains how to use the [software-review dashboard](https://dashboard.ropensci.org/).
We added a section on challenges, and documented how to put the system on vacation.
...
Besides, the [licencing section](https://devdevguide.netlify.app/pkg_building#licence) now explictly state one should acknowledge authors of bundled code.
Last but not least, the [section about dependencies](https://devdevguide.netlify.app/pkg_building#pkgdependencies) recommends to check the development status of dependencies.
...
- a note on top-level code in tests written with testthat.

## Package Documentation

We documented :wink: our documentation building system a bit better, thanks in particular to [Alasdair Warwick ](https://github.com/rmgpanw):

- More details on how to [safeguard](https://devdevguide.netlify.app/pkg_ci#rodocsci) docs building for rOpenSci packages;
...
-  in the [authorship](https://devdevguide.netlify.app/pkg_building.html#authorship) section of the packaging guide, [ROR IDs](/blog/2025/05/09/ror/);
...
In this post we summarized the changes incorporated into our book [“rOpenSci Packages: Development, Maintenance, and Peer Review”](https://devguide.ropensci.org) since the last release.
