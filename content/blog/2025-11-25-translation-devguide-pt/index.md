...
With the translation now complete, we plan to integrate the lessons learned into rOpenSci’s [official translation guidelines](https://translationguide.ropensci.org/). The goal is to update the guide to document successful practices from the project and to incorporate the agreements and instructions developed by the Portuguese translation team, making it easier to support future collaborations and translations into other languages. We hope that this will strengthen rOpenSci’s infrastructure for future translation efforts!
