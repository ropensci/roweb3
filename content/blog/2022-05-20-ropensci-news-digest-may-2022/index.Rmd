...
These metrics are not the only improvement to package individual pages:
You might have also noticed (and used!) 
...
* You could use `usethis::ui_todo()` paired with `usethis::ui_code()`, as done in usethis itself.

* If your code is run in RStudio, you could use `rstudioapi::sendToConsole()`. [Example](https://github.com/cynkra/fledge/blob/520b9b2e36da7bc58136378407f1f4454bfbeadf/R/finalize-version.R#L63-L80=).
