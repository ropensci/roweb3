...
Read more in our [blog post](/blog/2025/02/28/r-universe-docs-launch/), 
...
All the resources for the community call in Spanish [Fomentando la Ciencia Abierta en América Latina - Programa de rOpenSci](https://ropensci.org/es/commcalls/champions-latino-2025/) are now available on our website.
...
Have you heard of the beta IDE [Positron](https://positron.posit.co/) developed by Posit (formerly RStudio)?
...
The penguins dataset, originally from the [palmerpenguins](https://allisonhorst.github.io/palmerpenguins/) package, is [coming](https://developer.r-project.org/blosxom.cgi/R-devel/NEWS/2025/02/22) to the base R datasets package!
