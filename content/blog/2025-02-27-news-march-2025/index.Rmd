...
This event also gives the opportunity to meet in person with other members of rOpenSci in Sao Paulo, in the picture we can see Francesca Palmeira (rOpenSci Champions), Andrea Gomez Vargas (rOpenSci Champions), Beatriz Milz (rOpenSci Editor and Mentor), Haydee Svab (rOpenSci Champions) and Yanina Bellini Saibene (rOpenSci Community Manager).  
