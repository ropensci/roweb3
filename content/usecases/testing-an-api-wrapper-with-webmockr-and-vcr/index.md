...
reporter: "Dave Parr"
date: 2020-06-09
resource: "[webmockr](https://docs.ropensci.org/webmockr), [vcr](https://docs.ropensci.org/vcr), [HTTP testing book](https://books.ropensci.org/http-testing/)"
original_url: "https://discuss.ropensci.org/t/testing-an-api-wrapper-with-webmockr-and-vcr/2125"
language: [English]
---

#### rOpenSci package or resource used*
[webmockr](https://docs.ropensci.org/webmockr/) and [vcr](https://docs.ropensci.org/vcr/) with the [HTTP testing book](https://books.ropensci.org/http-testing/). A question on rOpenSci discourse helped me discover the tools.
