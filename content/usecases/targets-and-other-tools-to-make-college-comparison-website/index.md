...
resource: "The [user manual](https://books.ropensci.org/targets/) for the [targets](https://docs.ropensci.org/targets) and [tarchetypes](https://docs.ropensci.org/tarchetypes) packages"
...
The [user manual](https://books.ropensci.org/targets/) for the [targets](https://docs.ropensci.org/targets) and [tarchetypes](https://docs.ropensci.org/tarchetypes) packages.
...
#### Image
![Teaching|690x438](targets-and-other-tools-to-make-college-comparison-website.jpeg)
...
#### Social Handles
Mastodon: https://mastodon.social/@omearabrian
