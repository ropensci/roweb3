...
<!--html_preserve--> <h2>About <a href = "https://docs.ropensci.org/targets/"</a><code>targets</code></a> {{< figure src = "technotes/2021-02-03-targets/targets.png" alt = "targets hex logo" height = "139" class = "pull-right" style = "margin-left: 10px">}}</h2> <!--/html_preserve-->
...
[`targets`](https://docs.rOpenSci.org/targets/) is the long-term successor of [`drake`](https://github.com/rOpenSci/drake)[^3], which in turn succeeded [Rich FitzJohn](/author/rich-fitzjohn/)'s groundbreaking [`remake`](https://github.com/richfitz/remake)[^4] package.
...
[`targets`](https://docs.rOpenSci.org/targets/) inspects your code and constructs a dependency 

```{r, echo = FALSE}
tar_visnetwork() %>%
  visOptions(width = "100%", height = "500px") %>%
  visSave(file = "2021-02-03-targets/graph-minimal.html")
```
...
<!--html_preserve--> 
<iframe src = "2021-02-03-targets/graph-minimal.html" width = "100%" height = "550px" frameBorder="0" title = "dependency graph of the minimal example"></iframe>
<!--/html_preserve-->
...
<!--html_preserve-->
{{< figure src = "technotes/2021-02-03-targets/histogram.png" alt = "histogram of ozone readings from the airquality dataset in base R" height = "400px" width = "100%">}}
<!--/html_preserve-->
...
<!--html_preserve--> <h2> R Targetopia {{< figure src = "technotes/2021-02-03-targets/targetopia.png" alt = "targetopia hex logo" height = "139" class = "pull-right" >}} </h2>  <!--/html_preserve-->
...
<!--html_preserve--> <h3><a href = "https://wlandau.github.io/stantargets/"</a><code>stantargets</code></a> {{< figure src = "technotes/2021-02-03-targets/stantargets.png" alt = "stantargets hex logo" height = "139" class = "pull-right" >}}</h3> <!--/html_preserve-->
...
tar_visnetwork() %>%
  visOptions(width = "100%", height = "500px") %>%
  visSave(file = "2021-02-03-targets/graph-stantargets.html")
```
...
<!--html_preserve--> 
<iframe src = "2021-02-03-targets/graph-stantargets.html" width = "100%" height = "550px" frameBorder="0" title = "stantargets dependency graph"></iframe>
<!--/html_preserve-->

<!--html_preserve--> <h3><a href = "https://docs.ropensci.org/tarchetypes/"</a><code>tarchetypes</code></a> {{< figure src = "technotes/2021-02-03-targets/tarchetypes.png" alt = "tarchetypes hex logo" height = "139" class = "pull-right" >}}</h3> <!--/html_preserve-->
