...
<!--html_preserve--> <h2>About <a href = "https://docs.ropensci.org/targets/"</a><code>targets</code></a> {{< figure src = "technotes/2021-02-03-targets/targets.png" alt = "targets hex logo" height = "139" class = "pull-right">}}</h2> <!--/html_preserve-->
...
<!--html_preserve--> 
<iframe src = "technotes/2021-02-03-targets/graph-minimal.html" width = "100%" height = "550px" frameBorder="0" title = "dependency graph of the minimal example"></iframe>
<!--/html_preserve-->
...
<!--html_preserve--> 
<iframe src = "technotes/2021-02-03-targets/graph-stantargets.html" width = "100%" height = "550px" frameBorder="0" title = "stantargets dependency graph"></iframe>
<!--/html_preserve-->
