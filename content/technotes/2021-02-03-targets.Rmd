...
<!--html_preserve--> <h2>targets {{< figure src = "technotes/2021-02-03-targets/targets.png" alt = "targets hex logo" height = "139" class = "pull-right" style = "margin-left: 25px">}}</h2> <!--/html_preserve-->
...
<!--html_preserve--> <h2> R Targetopia {{< figure src = "technotes/2021-02-03-targets/targetopia.png" alt = "targetopia hex logo" height = "139" class = "pull-right" style = "margin-left: 25px" >}} </h2>  <!--/html_preserve-->
...
<!--html_preserve--> <h3>stantargets {{< figure src = "technotes/2021-02-03-targets/stantargets.png" alt = "stantargets hex logo" height = "139" class = "pull-right" style = "margin-left: 25px" >}}</h3> <!--/html_preserve-->
...
<!--html_preserve--> <h3>tarchetypes {{< figure src = "technotes/2021-02-03-targets/tarchetypes.png" alt = "tarchetypes hex logo" height = "139" class = "pull-right" style = "margin-left: 25px">}}</h3> <!--/html_preserve-->
