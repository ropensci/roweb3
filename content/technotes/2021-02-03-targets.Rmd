...
<!--html_preserve-->
<h2>The R Targetopia <a href="https://wlandau.github.io/targetopia/">{{< figure src = "technotes/2021-02-03-targets/targetopia.png" alt = "R Targetopia hex logos" height = "278" class = "pull-right" >}}</a></h2>
<!--/html_preserve-->
...
<!--html_preserve-->
<h3>stantargets <a href="https://wlandau.github.io/stantargets/">{{< figure src = "technotes/2021-02-03-targets/stantargets.png" alt = "stantargets hex logo" height = "139" class = "pull-right"  >}}</a></h3>
<!--/html_preserve-->
