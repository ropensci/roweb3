...
<!--html_preserve-->
<h2>The R Targetopia <a href="https://wlandau.github.io/targetopia/">{{< figure src = "technotes/2021-02-03-targets/targetopia.png" alt = "R Targetopia hex logos" height = "260" class = "pull-right" >}}</a></h2>
<!--/html_preserve-->
