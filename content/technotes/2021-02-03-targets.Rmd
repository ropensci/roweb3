...
<!--html_preserve--> <h2>targets {{< figure src = "technotes/2021-02-03-targets/targets.png" alt = "targets hex logo" height = "139" class = "pull-right">}}</h2> <!--/html_preserve-->
...
```{r, echo = FALSE}
tar_visnetwork() %>%
  visOptions(width = "350px", height = "400px") %>%
...
<iframe src = "../../../../2021-02-03-targets/graph-minimal.html" width = "350px" height = "400px" frameBorder="0" title = "dependency graph of the minimal example"></iframe>
<!--/html_preserve-->
...
<!--html_preserve--> <h3>stantargets {{< figure src = "technotes/2021-02-03-targets/stantargets.png" alt = "stantargets hex logo" height = "139" class = "pull-right" >}}</h3> <!--/html_preserve-->
...
<!--html_preserve-->
<!-- The dots in the src are not ideal, but they get me to the path of the widget -->
<iframe src = "../../../../2021-02-03-targets/graph-stantargets.html" width = "350px" height = "400px" frameBorder="0" title = "stantargets dependency graph"></iframe>
<!--/html_preserve-->

<!--html_preserve--> <h3>tarchetypes {{< figure src = "technotes/2021-02-03-targets/tarchetypes.png" alt = "tarchetypes hex logo" height = "139" class = "pull-right" >}}</h3> <!--/html_preserve-->
