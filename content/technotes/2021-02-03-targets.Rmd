...
<!--html_preserve--> <h2> R Targetopia {{< figure src = "technotes/2021-02-03-targets/targetopia.png" alt = "targets hex logo" height = "139" class = "pull-right" >}} </h2>  <!--/html_preserve-->
...
<!--html_preserve--> <h3><a href = "https://wlandau.github.io/stantargets/"</a><code>stantargets</code></a> {{< figure src = "technotes/2021-02-03-targets/stantargets.png" alt = "targets hex logo" height = "139" class = "pull-right" >}}</h3> <!--/html_preserve-->
...
<!--html_preserve--> <h3><a href = "https://docs.ropensci.org/tarchetypes/"</a><code>tarchetypes</code></a> {{< figure src = "technotes/2021-02-03-targets/tarchetypes.png" alt = "targets hex logo" height = "139" class = "pull-right" >}}</h3> <!--/html_preserve-->
