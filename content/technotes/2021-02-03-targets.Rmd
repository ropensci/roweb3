...
```{r minimal-graph, hugoopts = list(alt = "minimal graph"), eval = TRUE}
# R console
library(targets)
tar_visnetwork()
```
...
```{r histogram, hugoopts = list(alt = "histogram")}
# R console
...
```{r stantargets-graph, hugoopts = list(alt = "stantargets graph"), eval = TRUE}
# R console
tar_visnetwork()
```
