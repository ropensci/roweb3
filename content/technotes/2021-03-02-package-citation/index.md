...
* If you write a [JOSS](https://joss.theoj.org/) or some other software publication where you describe the software, then add that citation to the CITATION file as well.
