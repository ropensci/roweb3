...
[This chapter](https://books.rOpenSci.org/targets/drake.html) explains the future of [`drake`](https://github.com/rOpenSci/drake), the advantages of [`targets`](https://docs.rOpenSci.org/targets/), and how to transition.
