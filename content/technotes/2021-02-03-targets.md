...
{{< figure src = "2021-02-03-targets/targets.png" alt = "targets hex logo" class = "pull-left" >}}

[`targets`](https://docs.ropensci.org/targets/) is the long-term successor of [`drake`](https://github.com/ropensci/drake)[^3], which in turn succeeded [Rich FitzJohn](https://ropensci.org/author/rich-fitzjohn/)'s groundbreaking [`remake`](https://github.com/richfitz/remake)[^4] package.
[Click here](https://books.ropensci.org/targets/drake.html) to learn about the future of [`drake`](https://github.com/ropensci/drake), the advantages of [`targets`](https://docs.ropensci.org/targets/), and how to transition.
...
A target factory is reusable shorthand to return an entire list of target objects, ideally from inside a package.
...
{{< figure src = "2021-02-03-targets/targetopia.png" alt = "targetopia hex logo" class = "pull-left" >}}
...
This was especially true for [`targets`](https://docs.ropensci.org/targets/) because of overlap with the holidays, COVID-19, and the unusually copious workload.
...
[Sam Oliver](http://limnoliver.weebly.com) and [TJ Mahr](https://www.tjmahr.com) served as reviewers, and [Mauro Lepore](https://ropensci.org/author/mauro-lepore/) served as editor.
...
My colleague [Richard Payne](https://www.linkedin.com/in/richard-d-payne-2b3b0b3b/) was a serious [`drake`](https://docs.ropensci.org/drake/) user, and he built a proprietary [`drake_plan()`](https://docs.ropensci.org/drake/reference/drake_plan.html) generator for our team.
