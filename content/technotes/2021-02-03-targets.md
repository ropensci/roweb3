...
<!--html_preserve--> <h2> What is `targets`? {{< figure src = "technotes/2021-02-03-targets/targets.png" alt = "targets hex logo" height = "139" class = "pull-right" >}}</h2> <!--/html_preserve-->
